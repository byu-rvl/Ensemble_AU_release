...
with open(list_path_prefix + 'DISFA_test_img_path_fold3.txt','w') as f:
    u = 0
with open(list_path_prefix + 'DISFA_test_landmark_path_fold3.txt','w') as f:
    u = 0
...
for fr in part1:
    ...
    for i in range(total_frame):
        ...
        frame_landmark_name = fr + '/' + str(i) + '.npy'
        part1_landmark_list.append(frame_landmark_name)
        with open(list_path_prefix + 'DISFA_test_landmark_path_fold3.txt', 'a+') as f:
            f.write(frame_landmark_name+'\n')
...
with open(list_path_prefix + 'DISFA_test_landmark_path_fold2.txt','w') as f:
    u =0
...
for fr in part2:
    ...
    for i in range(total_frame):
        ...
        frame_landmark_name = fr + '/' + str(i) + '.npy'
        part2_landmark_list.append(frame_landmark_name)
        with open(list_path_prefix + 'DISFA_test_landmark_path_fold2.txt', 'a+') as f:
            f.write(frame_landmark_name + '\n')
...
with open(list_path_prefix + 'DISFA_test_landmark_path_fold1.txt','w') as f:
    u =0
...
for fr in part3:
    ...
    for i in range(total_frame):
        ...
        frame_landmark_name = fr + '/' + str(i) + '.npy'
        part3_landmark_list.append(frame_landmark_name)
        with open(list_path_prefix + 'DISFA_test_landmark_path_fold1.txt', 'a+') as f:
            f.write(frame_landmark_name + '\n')
...
with open(list_path_prefix + 'DISFA_train_img_path_fold1.txt','w') as f:
    u = 0
with open(list_path_prefix + 'DISFA_train_landmark_path_fold1.txt','w') as f:
    u = 0
train_img_label_fold1_list = part1_frame_list + part2_frame_list
train_landmark_label_fold1_list = part1_landmark_list + part2_landmark_list
for frame_img_name in train_img_label_fold1_list:
	with open(list_path_prefix + 'DISFA_train_img_path_fold1.txt', 'a+') as f:
		f.write(frame_img_name + '\n')
for frame_landmark_name in train_landmark_label_fold1_list:
    with open(list_path_prefix + 'DISFA_train_landmark_path_fold1.txt', 'a+') as f:
        f.write(frame_landmark_name + '\n')
...
with open(list_path_prefix + 'DISFA_train_img_path_fold2.txt','w') as f:
    u = 0
with open(list_path_prefix + 'DISFA_train_landmark_path_fold2.txt','w') as f:
    u = 0
train_img_label_fold2_list = part1_frame_list + part3_frame_list
train_landmark_label_fold2_list = part1_landmark_list + part3_landmark_list
for frame_img_name in train_img_label_fold2_list:
	with open(list_path_prefix + 'DISFA_train_img_path_fold2.txt', 'a+') as f:
		f.write(frame_img_name + '\n')
for frame_landmark_name in train_landmark_label_fold2_list:
    with open(list_path_prefix + 'DISFA_train_landmark_path_fold2.txt', 'a+') as f:
        f.write(frame_landmark_name + '\n')
...
with open(list_path_prefix + 'DISFA_train_img_path_fold3.txt','w') as f:
    u = 0
with open(list_path_prefix + 'DISFA_train_landmark_path_fold3.txt','w') as f:
    u = 0
train_img_label_fold3_list = part2_frame_list + part3_frame_list
train_landmark_label_fold3_list = part2_landmark_list + part3_landmark_list
for frame_img_name in train_img_label_fold3_list:
	with open(list_path_prefix + 'DISFA_train_img_path_fold3.txt', 'a+') as f:
		f.write(frame_img_name + '\n')
for frame_landmark_name in train_landmark_label_fold3_list:
    with open(list_path_prefix + 'DISFA_train_landmark_path_fold3.txt', 'a+') as f:
        f.write(frame_landmark_name + '\n')
